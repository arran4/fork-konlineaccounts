...
public:
    S3Setup(QObject *parent = nullptr);

    AccountBuilder *builder() const;
    void setBuilder(AccountBuilder *builder);
    Q_SIGNAL void builderChanged();

    Q_INVOKABLE void save(const QString &endpoint, const QString &region, const QString &accessKey, const QString &secretKey);
